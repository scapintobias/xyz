...
*/
			...
			8: [
				function(require, module, exports) {
					...
					}.call(this, require('./node_modules/_process')));
				},
				{ _process: 2 },
			],
			9: [
				...
				function(require, module, exports) {
					(function(process) {
						...
						if (process.env.NODE_ENV === 'production') {
							...
							module.exports = require('./cjs/react-is.development.js.js.js.js');
						}
					}.call(this, require('./node_modules/_process')));
				},
				{
					...
					(function(global) {
						...
						var BurgerIcon = (function(_Component) {
							...
							function BurgerIcon(props) {
								...
								_get(
									Object.getPrototypeOf(BurgerIcon.prototype),
									'constructor',
									this
								).call(this, props);
								...
								},
								{
									...
									value: function render() {
										...
										if (this.props.customIcon) {
											...
											icon = _react2['default'].cloneElement(
											...
											icon = _react2['default'].createElement(
												...
												[0, 1, 2].map(function(bar) {
													return _react2['default'].createElement('span', {
														...
														className: (
															'bm-burger-bars ' +
															_this.props.barClassName +
															' ' +
															(_this.state.hover ? 'bm-burger-bars-hover' : '')
														).trim(),
														style: _extends(
															{},
															_this.getLineStyle(bar),
															_this.props.styles.bmBurgerBars
														),
													});
												})
											);
					...
					(function(global) {
						...
						var CrossIcon = (function(_Component) {
							...
							function CrossIcon() {
								...
								_get(
									Object.getPrototypeOf(CrossIcon.prototype),
									'constructor',
									this
											...
											icon = _react2['default'].createElement(
												...
												['before', 'after'].map(function(type, i) {
													return _react2['default'].createElement('span', {
														...
														style: _extends(
															{},
															_this.getCrossStyle(type),
															_this.props.styles.bmCross
														),
													});
												})
											);
			...
			16: [
				...
				{ '../menuFactory': 15, '../snapsvgImporter': 26, '../utils': 27 },
			],
			17: [
				function(require, module, exports) {
					'use strict';
			...
			26: [
				function(require, module, exports) {
					...
					exports['default'] = function() {
						var Snap = undefined;
						try {
							Snap = require('./node_modules/snapsvg-cjs');
						} finally {
							return Snap;
						}
					};
